...
public class Controller {
    ...
    private void sletFraTabel(String tabel) {
        ...
        em.getTransaction().begin();
        try {
            Query q = em.createNativeQuery("DELETE from " + tabel);
    ...
    public Object[] TilValfagResultat(String[] pulje) {
        ...
        for (int i = 0; i < pulje.length; i++) {
            ...
            System.out.println("Mit valgfag: " + valgfag);
            int prioritet1 = Integer.parseInt(parts[1]);
            int prioritet2 = Integer.parseInt(parts[2]);
            //Lav et objekt
    ...
    /**
     * Beregner student tilfredshed ud fra deres valg og deres pladsering i
     * begge puljer, jo flere valg som eksistere i samme pulje jo mere utilfreds
     * studenten er. Metoden tjekker begge puljer for valgets eksistense, hvis
     * valget eksistere i ingen af puljer stiger utilfredshed også
     *
     */
