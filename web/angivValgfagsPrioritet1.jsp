    ...
    <body>
        <div id="main">
            ...
            <div id="mid">
                ...
                <h1>Første Valgfagsrunde</h1>
                <form action="PrioritetGemtServlet" method="get" class="andenP" >
                    ...
                    <br/>
                    <button type="submit" onclick="PrioritetGemtServlet" >Gem Prioritet</button>
